    ...
    public partial class receipt : Form
    {
        ...
        public void loadReceipt(string pcash,string pchange)
        {
            ...
            try
            {
                ...
                dbcon.open();
                da.SelectCommand = new SqlCommand("SELECT s.name, c.price FROM CashTBl AS c INNER JOIN ServiceTBL AS s ON c.serid=s.id WHERE c.TransNUMB LIKE '" + cash.lblTransno.Text+"'",dbcon.connect());
                ...
                ReportParameter pEmployee = new ReportParameter("pEmployee", login.empname);
                ...
                reportViewer1.LocalReport.SetParameters(pEmployee);
